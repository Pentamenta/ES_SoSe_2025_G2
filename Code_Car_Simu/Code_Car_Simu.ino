...
void debug_var_exchange() {

  data_to_dash.boolean_0_val = data_to_car.boolean_0_val;
  data_to_dash.boolean_1_val = data_to_car.boolean_1_val;
  data_to_dash.speed_actual_val = data_to_car.speed_target_val;
  data_to_dash.stear_actual_val = data_to_car.stear_target_val;
  data_to_dash.temperature_val = data_to_car.temperature_val;
